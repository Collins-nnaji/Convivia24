      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex border-b overflow-x-auto hide-scrollbar">
            <button
              className={`px-6 py-3 font-medium ${activeTab === 'venues' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <button
              className={`px-6 py-3 font-medium ${activeTab === 'upcoming' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-500 hover:text-gray-700'}`}
        ...
        {/* Plan Your Event - Prominent Call-to-Action */}
        {activeTab !== 'plan' && (
          <div className="mb-10 p-6 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl shadow-md">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h2 className="text-2xl font-bold text-red-800 mb-2">Ready to Plan Your Perfect Celebration?</h2>
                <p className="text-gray-700">Our AI-powered platform helps you organize every aspect of your event</p>
              </div>
              <button 
                onClick={() => setActiveTab('plan')}
                className="px-6 py-3 bg-gradient-to-r from-red-700 to-red-900 text-white rounded-full hover:shadow-lg transition-all"
              >
                Start Planning Now
              </button>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="relative">
                <select
                  className={`appearance-none bg-gray-100 rounded-full px-4 py-2 pr-8 focus:outline-none ${
                    eventCategories.find(cat => cat.id === eventType)
                      ? 'bg-gradient-to-r from-red-700 to-red-900 text-white' 
          ...
          {activeTab === 'venues' && (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {sortedVenues.slice(0, visibleItems).map((venue, index) => (
                  <motion.div
                    key={venue.id}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    onMouseEnter={() => setActiveItemIndex(venue.id)}
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      <img 
                        ...
                        style={{ 
                          transform: activeItemIndex === venue.id ? 'scale(1.1)' : 'scale(1)'
                        }}
                      />
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-yellow-400 fill-current" />
                          <span className="text-white ml-1 text-sm">{venue.rating}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="mb-3">
                        <p className="text-sm font-medium text-red-600">{venue.price}</p>
                      </div>
              ...
              {sortedVenues.length > visibleItems && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredEvents.map((event, index) => (
                  <motion.div
                    ...
                    className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg flex flex-col md:flex-row"
                  >
                    ...
                    <div className="p-4 md:w-2/3">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs rounded-full font-medium flex items-center">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center">
                          Join Event <Users className="ml-1 h-4 w-4" />
                        </button>
