...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/refer', destination: '/discover?tab=refer-and-earn', permanent: true },
      { source: '/refer/portal', destination: '/your-referrals', permanent: true },
      { source: '/refer/:path*', destination: '/discover?tab=refer-and-earn', permanent: true },
      { source: '/refer-and-earn', destination: '/discover?tab=refer-and-earn', permanent: true },
