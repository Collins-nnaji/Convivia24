...
function DocumentsPage() {
    var _this = this;
    _s();
    var _useState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]), 2), docs = _useState[0], setDocs = _useState[1];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DocumentsPage.useEffect": function() {
            load();
            fetch('/api/me').then({
                "DocumentsPage.useEffect": function(r) {
                    return r.ok ? r.json() : null;
                }
            }["DocumentsPage.useEffect"]).then({
                "DocumentsPage.useEffect": function(data) {
                    var _data_clients;
                    if ((data === null || data === void 0 ? void 0 : data.role) === 'admin' && (data === null || data === void 0 ? void 0 : (_data_clients = data.clients) === null || _data_clients === void 0 ? void 0 : _data_clients.length)) {
                        setMe(data);
    ...
    function handleUpload(e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
            var _e_target_files, file, presignRes, presignData, _presignData_error, uploadUrl, key, uploadRes, text, body, saveRes, saveData, _saveData_error, err, message;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                    ...
                    case 2:
                        presignRes = _state.sent();
                        return [
                            4,
                            presignRes.json().catch(function() {
                                return {};
                            })
                        ];
                    case 3:
                        presignData = _state.sent();
                        if (!presignRes.ok) {
                            ;
                            throw new Error((_presignData_error = presignData === null || presignData === void 0 ? void 0 : presignData.error) !== null && _presignData_error !== void 0 ? _presignData_error : "Failed to get upload URL (".concat(presignRes.status, ")"));
                        }
                        uploadUrl = presignData.uploadUrl, key = presignData.key;
                    ...
                    case 5:
                        text = _state.sent();
                        throw new Error("Storage upload failed (".concat(uploadRes.status, "). ").concat(text.slice(0, 100)));
                    case 6:
                        // 3. Save record
                        setProgress('Saving…');
                        body = {
                        ...
                        if ((me === null || me === void 0 ? void 0 : me.role) === 'admin' && selectedClientId) body.clientId = selectedClientId;
                        return [
                            4,
                            fetch('/api/documents', {
                                method: 'POST',
                    ...
                    case 7:
                        ...
                        return [
                            4,
                            saveRes.json().catch(function() {
                                return {};
                            })
                        ];
                    case 8:
                        saveData = _state.sent();
                        if (!saveRes.ok) {
                            ;
                            throw new Error((_saveData_error = saveData === null || saveData === void 0 ? void 0 : saveData.error) !== null && _saveData_error !== void 0 ? _saveData_error : "Failed to save document (".concat(saveRes.status, ")"));
                        }
                        setProgress('');
                        return [
                            4,
                    ...
                    case 10:
                        err = _state.sent();
                        message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(err, Error) ? err.message : 'Upload failed';
                        setProgress("Error: ".concat(message));
                        return [
                            3,
                            12
                        ];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "All documents shared with your account"
                    }, void 0, false, {
                        fileName: "[project]/app/dashboard/documents/page.tsx",
                        lineNumber: 122,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-zinc-900 border border-zinc-800 border-dashed p-8 mb-6 text-center",
                children: [
                    ...
                    (me === null || me === void 0 ? void 0 : me.role) === 'admin' && (me.clients && me.clients.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-3 flex justify-center",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                className: "text-xs text-zinc-500 mr-2",
                                children: "Client:"
                            }, void 0, false, {
                                fileName: "[project]/app/dashboard/documents/page.tsx",
                                lineNumber: 132,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                className: "bg-zinc-800 border border-zinc-700 text-white text-sm px-3 py-1.5 rounded focus:outline-none focus:border-red-700",
                                children: me.clients.map(function(c) {
                        ...
                        children: "Create a client in Admin first, then upload."
                    }, void 0, false, {
                        fileName: "[project]/app/dashboard/documents/page.tsx",
                        lineNumber: 144,
                        columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        htmlFor: "file-upload",
                        className: "inline-flex items-center gap-2 bg-red-700 hover:bg-red-800 text-white text-sm font-black uppercase tracking-[0.1em] px-5 py-2.5 cursor-pointer transition-colors ".concat(uploading ? 'opacity-50 pointer-events-none' : ''),
                        children: uploading ? progress || 'Uploading…' : 'Choose File'
                    }, void 0, false, {
                        fileName: "[project]/app/dashboard/documents/page.tsx",
                        lineNumber: 148,
                        columnNumber: 9
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "text-sm font-black uppercase tracking-[0.15em] text-white",
                            children: [
                                docs.length,
                                " Document",
                                docs.length !== 1 ? 's' : ''
                    ...
                    !loading && docs.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-zinc-600 text-sm text-center py-8",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: docs.map(function(doc) {
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DocumentsPage, "kXikllynYnegF3zn+uCO+ntBBI8=");
_c = DocumentsPage;
var _c;
...
var Upload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("Upload", __iconNode);
;
...
var FileText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("FileText", __iconNode);
;
...
var Trash2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("Trash2", __iconNode);
;
...
//# sourceMappingURL=_311869d2._.js.map