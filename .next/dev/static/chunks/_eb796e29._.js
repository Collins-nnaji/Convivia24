...
function AdminJobs() {
    ...
    var filterBookings = function() {
        ...
        if (searchQuery) {
            filtered = filtered.filter(function(b) {
                var _b_service_name, _b_business_name;
                return ((_b_service_name = b.service_name) === null || _b_service_name === void 0 ? void 0 : _b_service_name.toLowerCase().includes(searchQuery.toLowerCase())) || ((_b_business_name = b.business_name) === null || _b_business_name === void 0 ? void 0 : _b_business_name.toLowerCase().includes(searchQuery.toLowerCase()));
            });
        }
...
_s(AdminJobs, "27gxmdYzggJSnVjn8BC3uL6sCrg=", false, function() {
    return [
...
//# sourceMappingURL=_eb796e29._.js.map