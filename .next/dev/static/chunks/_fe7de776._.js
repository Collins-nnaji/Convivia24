...
function SignInPage() {
        ...
        "SignInPage.useEffect": function() {
            var checkSession = function checkSession() {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                    "SignInPage.useEffect.checkSession": function() {
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                            "SignInPage.useEffect.checkSession": function(_state) {
                                switch(_state.label){
                                    case 0:
                                        _state.trys.push([
                                            0,
                                    ...
                                    case 1:
                                        ...
                                        setDebugInfo("getSession: ".concat(JSON.stringify(res)));
                                        return [
                                            3,
                                            4
                                        ];
                        ...
                        }["SignInPage.useEffect.checkSession"]);
                    }
                }["SignInPage.useEffect.checkSession"])();
            };
            var mounted = true;
    ...
    function handleEmail(e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
            var _this, _data, _this1, _data1, _this2, _this3, _data2, _this4, _this5, res, _$err, hasUser, err;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        ...
                        return [
                            4,
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                                email: email,
                                password: password,
                    ...
                    case 2:
                        res = _state.sent();
                        setDebugInfo("signIn.email: ".concat(JSON.stringify(res)));
                        ...
                        hasUser = !!((_this2 = res) === null || _this2 === void 0 ? void 0 : (_data1 = _this2.data) === null || _data1 === void 0 ? void 0 : _data1.user) || ((_this3 = res) === null || _this3 === void 0 ? void 0 : _this3.user) || ((_this4 = res) === null || _this4 === void 0 ? void 0 : (_data2 = _this4.data) === null || _data2 === void 0 ? void 0 : _data2.session) || ((_this5 = res) === null || _this5 === void 0 ? void 0 : _this5.session);
                        if (_$err) {
                            setError(_$err.message || 'Sign in failed.');
                            setLoading(false);
                            return [
                                2
                            ];
                    ...
                    case 3:
                        err = _state.sent();
                        setError((err === null || err === void 0 ? void 0 : err.message) || 'Sign in failed.');
                        return [
                            3,
                            5
                        ];
    ...
    function handleCheckSession() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
            var _data, _this, _this1, res, user, err;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                        _state.trys.push([
                    ...
                    case 1:
                        ...
                        user = ((_this = res) === null || _this === void 0 ? void 0 : (_data = _this.data) === null || _data === void 0 ? void 0 : _data.user) || ((_this1 = res) === null || _this1 === void 0 ? void 0 : _this1.user);
                        setHasSession(!!user);
                        setDebugInfo("getSession (manual): ".concat(JSON.stringify(res)));
                        return [
                            3,
                            3
                        ];
                    case 2:
                        err = _state.sent();
                        setDebugInfo("getSession (manual) error: ".concat((err === null || err === void 0 ? void 0 : err.message) || 'unknown error'));
                        return [
                            3,
                            3
                        ];
    ...
    function handleCheckServerSession() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
            var res, data, err;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    ...
                    case 2:
                        data = _state.sent();
                        setDebugInfo("serverSession: ".concat(JSON.stringify(data)));
                        return [
                            3,
                            4
                        ];
                    case 3:
                        err = _state.sent();
                        setDebugInfo("serverSession error: ".concat((err === null || err === void 0 ? void 0 : err.message) || 'unknown error'));
                        return [
                            3,
                            4
                        ];
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        hasSession && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Session detected. Use the buttons below to continue."
                        }, void 0, false, {
                            fileName: "[project]/app/auth/sign-in/page.tsx",
                            lineNumber: 146,
                            columnNumber: 13
                        ...
                        !!debugInfo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mb-4 border border-zinc-800 bg-zinc-950/60 p-3 text-[10px] text-zinc-400 whitespace-pre-wrap",
                            children: debugInfo
                        }, void 0, false, {
                            fileName: "[project]/app/auth/sign-in/page.tsx",
                            lineNumber: 149,
...
_s(SignInPage, "aNLU7peqFTpCsWG1QeeaQI+YSA0=");
_c = SignInPage;
var _c;
...
//# sourceMappingURL=_fe7de776._.js.map