...
async function GET() {
    ...
    const docs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]`SELECT * FROM documents WHERE client_id = ${clientId} ORDER BY created_at DESC`;
...
async function POST(req) {
    ...
    if (!clientId) {
        const msg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canAccessAdmin"])(appUser) ? 'Admins must select a client when uploading (use the client dropdown on the Documents page).' : 'Your account is not linked to a client. Contact support to get access to document uploads.';
    ...
    const [doc] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7091a4b0._.js.map