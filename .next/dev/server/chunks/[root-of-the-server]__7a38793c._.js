...
const auth = {
    getSession: ()=>getAuth().getSession(),
    handler: ()=>getAuth().handler(),
    middleware: (config)=>getAuth().middleware(config)
};
}),
"[project]/app/api/auth/debug/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuth"])().getSession();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a38793c._.js.map