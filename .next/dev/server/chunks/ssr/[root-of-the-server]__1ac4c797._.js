...
function SignUpPage() {
    ...
    async function handleEmail(e) {
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signUp.email({
                name,
                email,
                password,
            ...
            const redirectUrl = res?.data?.url || res?.url || '/dashboard';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ac4c797._.js.map