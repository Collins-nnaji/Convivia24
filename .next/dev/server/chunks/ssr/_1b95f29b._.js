...
"[project]/app/(app)/admin/jobs/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminJobs() {
    ...
    const filterBookings = ()=>{
        ...
        if (searchQuery) {
            filtered = filtered.filter((b)=>b.service_name?.toLowerCase().includes(searchQuery.toLowerCase()) || b.business_name?.toLowerCase().includes(searchQuery.toLowerCase()));
        }
...
//# sourceMappingURL=_1b95f29b._.js.map