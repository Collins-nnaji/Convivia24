...
"[project]/app/admin/pipeline/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function AdminPipelinePage() {
    ...
    const deals = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]`
  ...
  `;
    ...
    const totalOpen = deals.filter((d)=>![
            'closed_won',
            'closed_lost'
        ].includes(d.stage));
    const totalValue = totalOpen.reduce((sum, d)=>sum + parseFloat(d.value || 0), 0);
...
"[project]/app/admin/pipeline/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/app/admin/pipeline/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__e3d2202a._.js.map