...
const PACKAGE_DEFS: PackageDef[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { slug: 'martell-vs', qty: 1 },
      { slug: 'smirnoff-ice-pack', qty: 18 },
      { slug: 'schweppes-tonic-pack', qty: 9 },
    ],
  },
  {
    ...
    components: [
      ...
      { slug: 'smirnoff-ice-pack', qty: 32 },
      { slug: 'schweppes-tonic-pack', qty: 18 },
    ],
  },
  // ── WEDDING ─────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    components: [
      ...
      { slug: 'johnnie-walker-black', qty: 2 },
      { slug: 'absolut-vodka', qty: 2 },
      { slug: 'schweppes-tonic-pack', qty: 14 },
      { slug: 'smirnoff-ice-pack', qty: 8 },
    ],
  },
  {
  ...
  },
  {
    ...
    components: [
      ...
      { slug: 'schweppes-tonic-pack', qty: 7 },
    ],
  },
  {
  ...
  },
  {
    ...
    components: [
      { slug: 'schweppes-tonic-pack', qty: 32 },
      { slug: 'smirnoff-ice-pack', qty: 48 },
    ],
  },
];
