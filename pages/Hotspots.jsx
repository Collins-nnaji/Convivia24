          ...
          {isLoaded ? (
            sortedHotspots.slice(0, visibleItems).map((hotspot, index) => (
              <div
                ...
                onMouseEnter={() => setActiveItemIndex(hotspot.id)}
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  <img 
                    ...
                    style={{ 
                      transform: activeItemIndex === hotspot.id ? 'scale(1.1)' : 'scale(1)'
                    }}
                  />
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    <div className="flex items-center">
                      <Star className="h-4 w-4 text-yellow-400 fill-current" />
                      <span className="text-white ml-1 text-sm">{hotspot.rating}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <span className="text-sm text-gray-600">Capacity: {hotspot.capacity}</span>
                  </div>
                  
                  <div className="flex items-center mb-3">
                    <Clock className="h-4 w-4 text-gray-600 mr-1" />
                    <span className="text-sm text-gray-600">{hotspot.openingHours}</span>
                  </div>
                  
                  <div className="flex items-center mb-3">
                    <Calendar className="h-4 w-4 text-gray-600 mr-1" />
                    <span className="text-sm text-gray-600">{hotspot.eventsToday} events today</span>
                  </div>
                  
                  <div className="mb-3">
                    <p className="text-sm font-medium text-red-600">{hotspot.price}</p>
                  </div>
                  
                  <div className="flex flex-wrap gap-1 mb-4">
                    {hotspot.features.slice(0, 3).map((feature, index) => (
                      <span 
                        key={index}
